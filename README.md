...
**Status:** v1.2.2 — Indic reph reordering fix on top of v1.2's
bounded shape cache (LRU), v1.1's Latin autohinter, and v1.0's
complex-script punch list. UAX #9 bidi
